...
public class ListTasksForTeammateRequestTest {
    ...
    @Test
    public void testListTasksForTeammateRequest() {
        ListTasksForTeammateRequest handler = new ListTasksForTeammateRequest(s3Client);
