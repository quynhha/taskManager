...
public class AddTeammateToProjectHandler implements RequestStreamHandler {
	...
	public AddTeammateToProjectHandler() {
	...
	public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
		...
		try {
			...
			this.formatResponse(new Gson().toJson(dao.addTeammateToProject(teammateName, projectName)), 200);
		} catch (Exception e) {
